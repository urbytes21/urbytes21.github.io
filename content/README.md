...
| REQ/INT Function | SystemC Mapping |
|-----------------|-----------------|
...
```
---
## Example Exercise: 4-bit Up-Counter (MCU Basic SystemC)
The following implements a 4-bit up-counter with synchronous reset — a typical MCU_Basic exercise.
```cpp
#include <systemc.h>
// ── Module Definition ───────────────────────────────────────────────────────
